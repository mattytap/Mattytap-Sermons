...
The current release is **3.1**, the first stable release of the renamed line.

1. Open the [Releases page](https://github.com/mattytap/Mattytap-Sermons/releases) and download `mattytap-sermons-3.1.zip` from the latest release.
...
Latest tag: `3.1`, the first stable release of the renamed line. WordPress.org submission as `mattytap-sermons` is in progress.
