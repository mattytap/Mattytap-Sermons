...
The current release is **3.1-rc3**, the third release-candidate of the renamed line.

1. Open the [Releases page](https://github.com/mattytap/Mattytap-Sermons/releases) and download `mattytap-sermons-3.1-rc3.zip` from the latest release.
...
Latest tag: `3.1-rc3`. WordPress.org resubmission as `mattytap-sermons` is queued following a 2026-05-11 trademark rejection of the `sermon-works` slug.
