...
1. Open the [Releases page](https://github.com/mattytap/Mattytap-Sermons/releases) and download `mattytap-sermons-3.1.1.zip` from the latest release.
...
Latest tag: `3.1.1`, completing the rename in user-visible admin text. WordPress.org submission as `mattytap-sermons` is in progress.
