	...
	function sermon_export_wp( $args = array() ) {
		...
		>
			...
			<channel>
				...
				<wp:base_site_url><?php echo esc_url( wxr_site_url() ); ?></wp:base_site_url>
				...
				<?php foreach ( $terms as $t ) : ?>
					<wp:term>
						...
						<wp:term_taxonomy><?php echo esc_html( $t->taxonomy ); ?></wp:term_taxonomy>
						<wp:term_slug><?php echo esc_html( $t->slug ); ?></wp:term_slug>
						<wp:term_parent><?php echo $t->parent ? esc_html( $terms[ $t->parent ]->slug ) : ''; ?></wp:term_parent>
						<?php wxr_term_name( $t ); ?>
