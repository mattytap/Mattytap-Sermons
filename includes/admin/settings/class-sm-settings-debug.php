	...
	public function get_settings() {
		$settings = apply_filters( 'sm_debug_settings', array(
			...
			array(
				...
				'desc_tip' => __( 'By default, Mattytap Sermons overrides excerpt output to show audio player, detailed sermon data, etc... Some themes use different ways of outputting the excerpt, so sermon data can mistakenly be shown multiple times under the title. By checking this option, we try to fix that. Default unchecked.', 'mattytap-sermons' ),
				'default'  => 'no',
			),
			array(
			...
			array(
				...
				'desc_tip' => __( 'Forces loading of Mattytap Sermons views, while overriding theme overrides.', 'mattytap-sermons' ),
				'id'       => 'force_layouts',
				'default'  => 'no',
			),
			array(
