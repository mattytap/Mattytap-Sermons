...
class SM_Shortcodes {
	...
	function display_sermons( $atts = array() ) {
		...
		$args = array(
			...
			'before'             => '',
			'hide_filters'       => true,
			'hide_topics'        => \SermonManager::getOption( 'topic_filtering', 'yes' ) ? '' : 'yes',
			'hide_series'        => \SermonManager::getOption( 'series_filtering', 'yes' ) ? '' : 'yes',
			'hide_preachers'     => \SermonManager::getOption( 'preacher_filtering', 'yes' ) ? '' : 'yes',
			'hide_books'         => \SermonManager::getOption( 'book_filtering', 'yes' ) ? '' : 'yes',
			'hide_dates'         => \SermonManager::getOption( 'month_filtering' ) ? '' : 'yes',
			'include'            => '',
			'exclude'            => '',
